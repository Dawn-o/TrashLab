            ...
            <div className='flex justify-between max-md:justify-end items-center max-w-7xl w-full px-2 max-md:relative'>
                <nav className='max-md:absolute max-md:right-[150%]'>
                    <ul className='flex gap-6 items-center'>
                        {navItems.map((item, index) => {
                            return (
                                <li key={index} className={`font-medium text-[18px] px-2 py-4 max-md:text-[12px] rounded-[8px] max-md:rounded-[5px]  ${activeTab === index ? 'text-white bg-secondary' : 'text-black'}`}>
                ...
                <div className='flex gap-12 max-md:gap-8 max-sm:gap-4 items-center '>
                    <div
                        ...
                        className={`font-medium max-md:text-[9px] flex justify-center items-center ${!user ? "cursor-pointer" : ""} max-md:gap-1 gap-2 outline-2 max-md:outline-1 outline-[#EBEBEB] rounded-[8px] max-md:rounded-[5px] py-2 px-4 max-md:p-2`}>
