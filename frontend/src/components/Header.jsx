            ...
            <div className='flex justify-between max-md:justify-end items-center max-w-7xl w-full px-2 max-md:relative'>
                ...
                <div className='flex gap-12 max-md:gap-8 max-sm:gap-4 items-center '>
                    <div
                        ...
                        className={`font-medium max-md:text-[9px] flex justify-center items-center ${!points ? "cursor-pointer" : ""} max-md:gap-1 gap-2 outline-2 max-md:outline-1 outline-[#EBEBEB] rounded-[8px] max-md:rounded-[5px] py-2 px-4 max-md:p-2`}>
                        {user ?
                        ...
                        {!user ? (<p>Klik untuk Sign In</p>) : points ? (<p>Anda memiliki <span className='font-bold max-md:text-[11px] text-[20px]'>{points}</span> Poin</p>) : (<p>Anda belum memiliki poin</p>) }
                    </div>
